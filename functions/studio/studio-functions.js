...
// }
// let sampleString = "Today is the day";
...
function completeArrayReversal(array) {
    let reversedArray = [];
    for (let i=0; i<array.length; i++) {
        reversedArray.unshift(reverseCharacters(array[i]));
    }
    return reversedArray
} 

// console.log(completeArrayReversal(arrayTest3));
...
function areaOfARectangle(length=width, width=length) {
    let area = length * width;
    return area;
}
// console.log(`The area is ${areaOfARectangle(20)}cm^2.`)